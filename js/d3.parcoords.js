...
pc.createAxes = function() {
  ...
  g.append("svg:g")
      ...
      .each(function(d) {
        ...
        axisElement.selectAll("path")
            .style("fill", "none")
            .style("stroke", "rgba(99,226,255,0.7)")
  ...
  if (__.nullValueSeparator=="top") {
    pc.svg.append("line")
      ...
      .attr("stroke-width", 1)
      .attr("stroke", "rgba(99,226,255,0.7)")
      .attr("fill", "none")
  ...
  function brushFor(axis) {
	...
	function install() {
		...
		brush.selectAll("rect.extent")
				.style("fill", "rgba(239,235,235,0.75)")
				.style("stroke", "rgba(239,235,235,0.76)");
...
(function() {
  ...
  function brushFor(axis) {
    ...
    brush
      ...
      .extentAdaption(function(selection) {
          ...
          .attr("x", -15)
          .attr("width", 30)
          .style("fill", "rgba(89,82,82,0.75)")
          .style("stroke", "rgba(89,82,82,0.75)");
      })
  ...
  function install() {
    ...
    brush.selectAll("rect.extent")
        ...
        .style("stroke", "rgba(255,255,255,0.62)");
